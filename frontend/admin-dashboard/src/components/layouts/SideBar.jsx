    ...
    <Link to={`${link !== "#" ? "/" + link : "#"}`}>
      <div className="flex w-full  items-end flex-col">
        ...
        >
          ...
          <span
            className={`font-inter flex-1 font-normal  whitespace-nowrap mr-2 `}
          >
            {title}
          </span>
          {children !== 0 && (
        ...
        {openChildren && (
          <ul className="w-[93%] border-[#8346FE] border-l-[4px]">
            {children !== 0 &&
                ...
                return (
                  <Link to={child.link}>
                    ...
                    >
                      ...
                      <span
                        className={`font-inter text-[13px] font-semibold whitespace-nowrap `}
                      >
                        {child.title}
                      </span>
                    </ListItem>
